...
from sae.pipeline import EmbeddingGenerator, run_complete_pipeline
...
def main():
    ...
    print("  - Training plot: outputs/training_history.png")
    print("  - Analysis plots: outputs/feature_analysis_*.png")
